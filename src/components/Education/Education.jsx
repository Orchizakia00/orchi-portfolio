        ...
        <div className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-12">
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img src="https://i.ibb.co/x8yKMsZ/nubt.jpg" className="h-[400px]" alt="Shoes" /></figure>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img src="https://i.ibb.co/D9q54H8/DAUD-PUBLIC-SCHOOL-AND-COLLEGE-Logo.png" className="h-[400px]" alt="Shoes" /></figure>
                    <div className="card-body">
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img src="https://i.ibb.co/gdncWxs/logo-4.png" className="h-[400px]" alt="Shoes" /></figure>
                    <div className="card-body">
